...
void FusedBiasReluFFN::forward(const TensorView &x, TensorView &out) {
  ...
  TensorContracts::validate_same_device_dtype(W1, x, "FusedBiasReluFFN",
                                              "W1/x");
  TensorContracts::validate_same_device_dtype(W2, x, "FusedBiasReluFFN",
                                              "W2/x");
...
void FusedBiasReluFFN::backward(const TensorView &dout, TensorView &dx) {
  ...
  TensorContracts::validate_same_device_dtype(dout, cache_x_,
                                              "FusedBiasReluFFN",
                                              "dout/cache_x");
  TensorContracts::validate_bsd_shape_like(dx, cache_x_, "FusedBiasReluFFN",
                                           "dx");
